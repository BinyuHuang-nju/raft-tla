...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ParallelRaftSE}\moduleRightDash\@xx{}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
...
\@xx{}%
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Integers ,\, FiniteSets ,\, Sequences ,\, TLC}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Server}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} Value}%
\@pvspace{8.0pt}%
 \@x{ {\CONSTANTS} Follower ,\, Candidate ,\, Leader ,\, LeaderCandidate ,\,
 Nil}%
\@x{}\midbar\@xx{}%
 \@x{ Quorums \.{\defeq} \{ i \.{\in} {\SUBSET} Server \.{:} Cardinality ( i )
 \.{*} 2 \.{>} Cardinality ( Server ) \}}%
\@pvspace{8.0pt}%
\@x{ Index \.{\defeq} \{ 0 ,\, 1 ,\, 2 ,\, 3 ,\, 4 ,\, 5 ,\, 6 \}}%
\@pvspace{8.0pt}%
\@x{ Term \.{\defeq} Nat}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
...
\@x{\@s{51.42} r3amsgs ,\,}%
\@x{\@s{51.42} negMsgs ,\,}%
\@x{\@s{51.42} currentTerm ,\,}%
\@x{\@s{51.42} currentState ,\,}%
\@x{\@s{51.42} vote ,\,}%
\@x{\@s{51.42} leaderLog ,\,}%
\@x{\@s{51.42} log}%
\@pvspace{8.0pt}%
 \@x{ msgsVars \.{\defeq} {\langle} r1amsgs ,\, r1bmsgs ,\, r2amsgs ,\,
 r2bmsgs ,\, r3amsgs {\rangle}}%
\@x{ serverVars \.{\defeq} {\langle} currentTerm ,\, currentState {\rangle}}%
 \@x{ vars \.{\defeq} {\langle} msgsVars ,\, serverVars ,\, negMsgs ,\, vote
 ,\, leaderLog ,\, log {\rangle}}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
 \@x{ Max ( s ) \.{\defeq} {\CHOOSE} i \.{\in} s \.{:} \A\, j \.{\in} s \.{:}
 i \.{\geq} j}%
\@pvspace{8.0pt}%
 \@x{ lastIndex ( i ) \.{\defeq} {\IF} \{ b \.{\in} Index \.{:} log [ i ] [ b
 ] [ 1 ] \.{\neq} \.{-} 1 \} \.{=} \{ \} \.{\THEN} \.{-} 1}%
 \@x{\@s{70.86} \.{\ELSE} Max ( \{ b \.{\in} Index \.{:} log [ i ] [ b ] [ 1 ]
 \.{\neq} \.{-} 1 \} )}%
\@pvspace{8.0pt}%
 \@x{ allEntries\@s{1.02} \.{\defeq} \{ {\langle} t ,\, v ,\, b {\rangle}
 \.{:} t\@s{20.26} \.{\in} Term \.{\cup} \{ \.{-} 1 \} ,\, v\@s{2.71} \.{\in}
 Value \.{\cup} \{ Nil \} ,\, b \.{\in} \{ {\TRUE} ,\, {\FALSE} \} \}}%
 \@x{ logEntries \.{\defeq} \{ {\langle} i ,\, e {\rangle} \.{:} i\@s{17.27}
 \.{\in} Index ,\, e \.{\in} allEntries \}}%
\@pvspace{8.0pt}%
 \@x{ TypeInv \.{\defeq} \.{\land} currentTerm \.{\in} [ Server
 \.{\rightarrow} Nat ]}%
 \@x{\@s{54.48} \.{\land} currentState \.{\in} [ Server \.{\rightarrow} \{
 Follower ,\, Leader ,\, LeaderCandidate ,\, Candidate \} ]}%
 \@x{\@s{54.48} \.{\land} log \.{\in} [ Server \.{\rightarrow} [ Index
 \.{\rightarrow} ( Term \.{\cup} \{ \.{-} 1 \} ) \.{\times} ( Value \.{\cup}
 \{ Nil \} ) \.{\times} {\BOOLEAN} ] ]}%
 \@x{\@s{54.48} \.{\land} r1amsgs \.{\subseteq} \{ {\langle} t ,\, i {\rangle}
 \.{:} t \.{\in} Term ,\, i \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} r1bmsgs\@s{0.51} \.{\subseteq} \{ {\langle} t ,\, e
 ,\, i ,\, j {\rangle}\@s{1.87} \.{:} t \.{\in} Term ,\, e\@s{1.03} \.{\in}
 {\SUBSET} logEntries ,\, i \.{\in} Server ,\, j \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} r2amsgs \.{\subseteq} \{ {\langle} t ,\, n ,\, e ,\,
 i {\rangle} \.{:} t \.{\in} Term ,\, n \.{\in} Index ,\, e \.{\in}
 allEntries ,\, i \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} r2bmsgs\@s{0.51} \.{\subseteq} \{ {\langle} t ,\, n
 ,\, i ,\, j {\rangle}\@s{0.83} \.{:} t \.{\in} Term ,\, n \.{\in} Index ,\,
 i\@s{1.26} \.{\in} Server ,\, j \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} r3amsgs \.{\subseteq} \{ {\langle} t ,\, n ,\, i
 {\rangle} \.{:} t \.{\in} Term ,\, n \.{\in} Index ,\, i \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} negMsgs\@s{0.30} \.{\subseteq} \{ {\langle} t ,\, i
 {\rangle} \.{:} t \.{\in} Term ,\, i \.{\in} Server \}}%
 \@x{\@s{54.48} \.{\land} log \.{\in} [ Server \.{\rightarrow} [ Index
 \.{\rightarrow} allEntries ] ]}%
 \@x{\@s{54.48} \.{\land} leaderLog \.{\in} [ Term \.{\rightarrow} [ Index
 \.{\rightarrow} allEntries ] ]}%
 \@x{\@s{54.48} \.{\land} vote \.{\in} [ Server \.{\rightarrow} [ Index
 \.{\rightarrow} [ Term \.{\rightarrow} Value \.{\cup} \{ Nil \} ] ] ]}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
\@x{ Init \.{\defeq} \.{\land} r1amsgs \.{=} \{ \}}%
\@x{\@s{35.70} \.{\land} r1bmsgs\@s{0.51} \.{=} \{ \}}%
\@x{\@s{35.70} \.{\land} r2amsgs \.{=} \{ \}}%
\@x{\@s{35.70} \.{\land} r2bmsgs\@s{0.51} \.{=} \{ \}}%
\@x{\@s{35.70} \.{\land} r3amsgs \.{=} \{ \}}%
\@x{\@s{35.70} \.{\land} negMsgs\@s{0.30} \.{=} \{ \}}%
 \@x{\@s{35.70} \.{\land} currentTerm \.{=} [ i \.{\in} Server \.{\mapsto} 0
 ]}%
 \@x{\@s{35.70} \.{\land} currentState \.{=} [ i \.{\in} Server \.{\mapsto}
 Follower ]}%
 \@x{\@s{35.70} \.{\land} vote \.{=} [ i\@s{2.94} \.{\in} Server \.{\mapsto} [
 j \.{\in} Index \.{\mapsto} [ t \.{\in} Term \.{\mapsto} Nil ] ] ]}%
 \@x{\@s{35.70} \.{\land} leaderLog \.{=} [ i \.{\in} Term \.{\mapsto} [ j
 \.{\in} Index \.{\mapsto} {\langle} \.{-} 1 ,\, Nil ,\, {\FALSE} {\rangle} ]
 ]}%
 \@x{\@s{35.70} \.{\land} log \.{=} [ i \.{\in} Server \.{\mapsto} [ j \.{\in}
 Index \.{\mapsto} {\langle} \.{-} 1 ,\, Nil ,\, {\FALSE} {\rangle} ] ]}%
\@pvspace{8.0pt}%
\@x{}\midbar\@xx{}%
 \@x{ Restart ( i ) \.{\defeq} \.{\land} currentState \.{'} \.{=} [
 currentState {\EXCEPT} {\bang} [ i ] \.{=} Follower ]}%
 \@x{\@s{63.14} \.{\land} {\UNCHANGED} {\langle} msgsVars ,\, currentTerm ,\,
 negMsgs ,\, vote ,\, leaderLog ,\, log {\rangle}}%
\@pvspace{8.0pt}%
\@x{ UpdateTerm ( i ,\, b ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land} currentTerm [ i ] \.{<} b}%
 \@x{\@s{32.8} \.{\land} currentTerm \.{'}\@s{4.1} \.{=} [ currentTerm\@s{4.1}
 {\EXCEPT} {\bang} [ i ] \.{=} b ]}%
 \@x{\@s{32.8} \.{\land} currentState \.{'}\@s{5.52} \.{=} [ currentState
 {\EXCEPT} {\bang} [ i ]\@s{5.52} \.{=} Follower ]}%
\@pvspace{8.0pt}%
\@x{ ReceiveHighTerm ( i ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land} \E\, m \.{\in} negMsgs \.{:} \.{\land} m [ i
 ]\@s{0.91} \.{>} currentTerm [ i ]}%
\@x{\@s{118.62} \.{\land} m [ 2 ] \.{=} i}%
\@x{\@s{118.62} \.{\land} UpdateTerm ( i ,\, m [ 1 ] )}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} msgsVars ,\, negMsgs ,\, vote
 ,\, leaderLog ,\, log {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Timeout ( i ) \.{\defeq}}%
 \@x{\@s{41.12} \.{\land} currentState [ i ] \.{\in} \{ Follower ,\, Candidate
 \}}%
 \@x{\@s{41.12} \.{\land} currentTerm \.{'} \.{=} [ currentTerm {\EXCEPT}
 {\bang} [ i ] \.{=} currentTerm [ i ] \.{+} 1 ]}%
 \@x{\@s{41.12} \.{\land} currentState \.{'} \.{=} [ currentState {\EXCEPT}
 {\bang} [ i ] \.{=} Candidate ]}%
\@x{\@s{41.12} \.{\land} ( currentTerm [ i ] \.{+} 1 ) \.{\in} Nat}%
 \@x{\@s{41.12} \.{\land} {\UNCHANGED} {\langle} msgsVars ,\, negMsgs ,\, vote
 ,\, leaderLog ,\, log {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RequestVote ( i ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land}\@s{9.38} currentState [ i ] \.{=} Candidate}%
 \@x{\@s{32.8} \.{\land}\@s{9.38} r1amsgs \.{'} \.{=} r1amsgs \.{\cup} \{
 {\langle} currentTerm [ i ] ,\, i {\rangle} \}}%
 \@x{\@s{32.8} \.{\land}\@s{9.38} {\UNCHANGED} {\langle} serverVars ,\,
 r1bmsgs ,\, r2amsgs ,\, r2bmsgs ,\, r3amsgs ,\, negMsgs ,\, log ,\,
 leaderLog ,\, vote {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HandleRequestVoteRequest ( i ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land} \E\, m \.{\in} r1amsgs \.{:}}%
\@x{\@s{48.01} \.{\LET} j \.{\defeq} m [ 2 ]}%
\@x{\@s{68.41} grant \.{\defeq} m [ 1 ] \.{>} currentTerm [ i ]}%
 \@x{\@s{68.41} entries \.{\defeq} \{ {\langle} n ,\, log [ i ] [ n ]
 {\rangle} \.{:} n \.{\in} Index \}}%
\@x{\@s{48.01} \.{\IN}}%
\@x{\@s{52.11} \.{\lor} \.{\land} grant}%
\@x{\@s{63.22} \.{\land} UpdateTerm ( i ,\, m [ 1 ] )}%
 \@x{\@s{63.22} \.{\land} r1bmsgs \.{'} \.{=} r1bmsgs \.{\cup} \{ {\langle} m
 [ 1 ] ,\, entries ,\, i ,\, j {\rangle} \}}%
\@x{\@s{63.22} \.{\land} {\UNCHANGED} negMsgs}%
\@x{\@s{52.11} \.{\lor} \.{\land} {\lnot} grant}%
 \@x{\@s{63.22} \.{\land} negMsgs \.{'} \.{=} negMsgs \.{\cup} \{ {\langle}
 currentTerm [ i ] ,\, j {\rangle} \}}%
 \@x{\@s{63.22} \.{\land} {\UNCHANGED} {\langle} currentState ,\, currentTerm
 ,\, r1bmsgs {\rangle}}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} log ,\, r1amsgs ,\, r2amsgs
 ,\, r2bmsgs ,\, r3amsgs ,\, vote ,\, leaderLog {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Merge ( entries ,\, term ,\, v ) \.{\defeq}}%
 \@x{\@s{39.31} \.{\LET} committed \.{\defeq} \{ e \.{\in} entries \.{:} e [ 3
 ] \.{=} {\TRUE} \}}%
 \@x{\@s{59.71} chosen \.{\defeq} {\CASE} committed \.{=}\@s{4.1} \{ \}
 \.{\rightarrow} {\CHOOSE} x \.{\in} entries \.{:} \A\, y \.{\in} entries
 \.{:} x [ 1 ] \.{\geq} y [ 1 ]}%
 \@x{\@s{108.50} {\Box}\@s{18.50} committed \.{\neq}\@s{4.09} \{ \}
 \.{\rightarrow} {\CHOOSE} x \.{\in} committed \.{:} {\TRUE}}%
 \@x{\@s{59.71} safe \.{\defeq} {\IF} chosen [ 2 ] \.{=} Nil \.{\THEN} v
 \.{\ELSE} chosen [ 2 ]}%
\@x{\@s{39.31} \.{\IN} {\langle} term ,\, safe ,\, chosen [ 3 ] {\rangle}}%
\@pvspace{8.0pt}%
\@x{ BecomeLeaderCandidate ( i ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land} currentState [ i ] \.{=} Candidate}%
\@x{\@s{32.8} \.{\land} \E\, Q \.{\in} Quorums \.{:}}%
 \@x{\@s{48.01} \.{\LET} voteGranted \.{\defeq} \{ m \.{\in} r1bmsgs \.{:} m [
 4 ] \.{=} i \.{\land} m [ 3 ] \.{\in} Q \.{\land} m [ 1 ] \.{=} currentTerm
 [ i ] \}\@s{8.2}}%
\@y{\@s{0}%
 \ensuremath{{\langle}m[1],\, entries,\, i,\, j{\rangle}
}}%
\@xx{}%
 \@x{\@s{68.41} allLog\@s{26.78} \.{\defeq} {\UNION} \{ m [ 2 ] \.{:} m
 \.{\in} voteGranted \}\@s{143.5}}%
\@y{\@s{0}%
 \ensuremath{{\langle}n,\, log[i][n]{\rangle}
}}%
\@xx{}%
 \@x{\@s{68.41} valid\@s{31.88} \.{\defeq} \{ e \.{\in} allLog \.{:} e [ 2 ] [
 1 ] \.{\neq} \.{-} 1 \}\@s{163.50}}%
\@y{\@s{0}%
 \ensuremath{log[i][n]}: \ensuremath{{\langle}t,\,v,\,b{\rangle}
}}%
\@xx{}%
 \@x{\@s{68.41} end\@s{36.99} \.{\defeq} {\IF} valid \.{=} \{ \} \.{\THEN}
 \.{-} 1 \.{\ELSE} Max ( \{ e [ 1 ] \.{:} e \.{\in} valid \} )}%
\@x{\@s{48.01} \.{\IN}}%
 \@x{\@s{64.41} \.{\land} \A\, q\@s{0.19} \.{\in} Q \.{:} \E\, m \.{\in}
 voteGranted \.{:} m [ 3 ] \.{=} q}%
 \@x{\@s{64.41} \.{\land} \E\, v \.{\in} Value \.{:} leaderLog \.{'} \.{=} [
 leaderLog {\EXCEPT} {\bang} [ currentTerm [ i ] ] \.{=} [ n \.{\in} Index
 \.{\mapsto}}%
 \@x{\@s{286.48} {\IF} n \.{\in} 0 \.{\dotdot} end \.{\THEN} Merge ( \{ l [ 2
 ] \.{:} l \.{\in} \{ t \.{\in} allLog \.{:} t [ 1 ] \.{=} n \} \} ,\,
 currentTerm [ i ] ,\, v )}%
 \@x{\@s{352.50} \.{\ELSE} {\langle} \.{-} 1 ,\, Nil ,\, {\FALSE} {\rangle} ]
 ]}%
 \@x{\@s{32.8} \.{\land} currentState \.{'} \.{=} [ currentState {\EXCEPT}
 {\bang} [ i ] \.{=} LeaderCandidate ]}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} currentTerm ,\, log ,\,
 msgsVars ,\, vote ,\, negMsgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RequestSync ( i ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land}\@s{10.20} currentState [ i ] \.{\in} \{
 LeaderCandidate ,\, Leader \}}%
 \@x{\@s{32.8} \.{\land}\@s{10.20} \.{\LET} sync \.{\defeq} \{ n \.{\in} Index
 \.{:} leaderLog [ currentTerm [ i ] ] [ n ] [ 1 ] \.{\neq} \.{-} 1 \}}%
 \@x{\@s{54.11} \.{\IN} \E\, n \.{\in} sync \.{:} r2amsgs \.{'} \.{=} r2amsgs
 \.{\cup} \{ {\langle} currentTerm [ i ] ,\, n ,\, leaderLog [ currentTerm [
 i ] ] [ n ] ,\, i {\rangle} \}}%
 \@x{\@s{32.8} \.{\land}\@s{10.20} {\UNCHANGED} {\langle} serverVars ,\, log
 ,\, leaderLog ,\, vote ,\, r1amsgs ,\, r1bmsgs ,\, r2bmsgs ,\, r3amsgs ,\,
 negMsgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HandleRequestSyncRequest ( i ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land} \E\, m \.{\in} r2amsgs \.{:}\@s{82.0}}%
\@y{\@s{0}%
 \ensuremath{{\langle}currentTerm[i],\, n,\, leaderLog[currentTerm[i]][n],\,
 i{\rangle}
}}%
\@xx{}%
\@x{\@s{48.01} \.{\LET} j\@s{18.79} \.{\defeq} m [ 4 ]}%
\@x{\@s{68.41} grant \.{\defeq} m [ 1 ] \.{\geq} currentTerm [ i ]}%
 \@x{\@s{48.01} \.{\IN} \.{\land} \.{\lor} \.{\land} m [ 1 ] \.{>} currentTerm
 [ i ]}%
\@x{\@s{90.63} \.{\land} UpdateTerm ( i ,\, m [ 1 ] )}%
\@x{\@s{79.52} \.{\lor} \.{\land} m [ 1 ] \.{\leq} currentTerm [ i ]}%
 \@x{\@s{90.63} \.{\land} {\UNCHANGED} {\langle} currentTerm ,\, currentState
 {\rangle}}%
\@x{\@s{68.41} \.{\land} \.{\lor} \.{\land} grant}%
 \@x{\@s{90.63} \.{\land} log \.{'} \.{=} [ log {\EXCEPT} {\bang} [ i ] [ m [
 2 ] ] \.{=} m [ 3 ] ]}%
 \@x{\@s{90.63} \.{\land} vote \.{'} \.{=} [ vote {\EXCEPT} {\bang} [ i ] [ m
 [ 2 ] ] [ m [ 1 ] ] \.{=} m [ 3 ] [ 2 ] ]}%
 \@x{\@s{90.63} \.{\land} r2bmsgs \.{'} \.{=} r2bmsgs \.{\cup} \{ {\langle} m
 [ 1 ] ,\, m [ 2 ] ,\, i ,\, j {\rangle} \}}%
\@x{\@s{90.63} \.{\land} {\UNCHANGED} negMsgs}%
\@x{\@s{79.52} \.{\lor} \.{\land} {\lnot} grant}%
 \@x{\@s{90.63} \.{\land} negMsgs \.{'} \.{=} negMsgs \.{\cup} \{ {\langle}
 currentTerm [ i ] ,\, j {\rangle} \}}%
 \@x{\@s{90.63} \.{\land} {\UNCHANGED} {\langle} log ,\, vote ,\, r2bmsgs
 {\rangle}}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} r1amsgs ,\, r1bmsgs ,\,
 r2amsgs ,\, r3amsgs ,\, leaderLog {\rangle}}%
\@pvspace{8.0pt}%
\@x{ CommitEntry ( i ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land}\@s{16.78} currentState [ i ] \.{\in} \{ Leader ,\,
 LeaderCandidate \}}%
 \@x{\@s{32.8} \.{\land}\@s{16.78} \E\, index \.{\in} Index ,\, Q \.{\in}
 Quorums \.{:}}%
 \@x{\@s{64.79} \.{\LET} syncSuccess \.{\defeq} \{ m \.{\in} r2bmsgs \.{:}
 \.{\land} m [ 4 ] \.{=} i}%
\@x{\@s{228.29} \.{\land} m [ 3 ] \.{\in} Q}%
\@x{\@s{228.29} \.{\land} m [ 1 ] \.{=} currentTerm [ i ]}%
\@x{\@s{228.29} \.{\land} m [ 2 ] \.{=} index \}}%
 \@x{\@s{64.79} \.{\IN} \.{\land} \A\, q \.{\in} Q \.{:} \E\, m \.{\in}
 syncSuccess \.{:} m [ 3 ] \.{=} q}%
 \@x{\@s{85.19} \.{\land} leaderLog \.{'} \.{=} [ leaderLog {\EXCEPT} {\bang}
 [ currentTerm [ i ] ] [ index ] [ 3 ] \.{=} {\TRUE} ]}%
 \@x{\@s{32.8} \.{\land}\@s{16.78} {\UNCHANGED} {\langle} serverVars ,\, log
 ,\, msgsVars ,\, negMsgs ,\, vote {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RequestCommit ( i ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\land} currentState [ i ] \.{\in} \{ Leader ,\,
 LeaderCandidate \}}%
 \@x{\@s{32.8} \.{\land} \.{\LET} committed \.{\defeq} \{ n \.{\in} Index
 \.{:} leaderLog [ currentTerm [ i ] ] [ n ] [ 3 ] \.{=} {\TRUE} \}}%
\@x{\@s{43.91} \.{\IN} \E\, n \.{\in} committed \.{:}}%
 \@x{\@s{72.51} r3amsgs \.{'} \.{=} r3amsgs \.{\cup} \{ {\langle} currentTerm
 [ i ] ,\, n ,\, i {\rangle} \}}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, log ,\, r1amsgs
 ,\, r1bmsgs ,\, r2amsgs ,\, r2bmsgs ,\, negMsgs ,\, leaderLog ,\, vote
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ HandleRequestCommitRequest ( i ) \.{\defeq}}%
\@x{\@s{32.8} \.{\land} \E\, m \.{\in} r3amsgs \.{:}}%
\@x{\@s{48.01} \.{\LET} j \.{\defeq} m [ 3 ]}%
\@x{\@s{68.41} grant \.{\defeq} currentTerm [ i ] \.{\leq} m [ 1 ]}%
 \@x{\@s{48.01} \.{\IN} \.{\land} \.{\lor} \.{\land} m [ 1 ] \.{>} currentTerm
 [ i ]}%
\@x{\@s{90.63} \.{\land} UpdateTerm ( i ,\, m [ 1 ] )}%
\@x{\@s{79.52} \.{\lor} \.{\land} m [ 1 ] \.{\leq} currentTerm [ i ]}%
 ...
 {\rangle}}%
\@x{\@s{68.41} \.{\land} \.{\lor} \.{\land} grant}%
\@x{\@s{90.63} \.{\land} log [ i ] [ m [ 2 ] ] [ 1 ] \.{=} m [ 1 ]}%
 \@x{\@s{90.63} \.{\land} log \.{'} \.{=} [ log {\EXCEPT} {\bang} [ i ] [ m [
 2 ] ] [ 3 ] \.{=} {\TRUE} ]}%
\@x{\@s{90.63} \.{\land} {\UNCHANGED} negMsgs}%
\@x{\@s{79.52} \.{\lor} \.{\land} {\lnot} grant}%
 \@x{\@s{90.63} \.{\land} negMsgs \.{'} \.{=} negMsgs \.{\cup} \{ {\langle}
 currentTerm [ i ] ,\, j {\rangle} \}}%
\@x{\@s{90.63} \.{\land} {\UNCHANGED} log}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} msgsVars ,\, leaderLog ,\,
 vote {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{32.8} \.{\land} currentState [ i ] \.{=} LeaderCandidate}%
 ...
 {\bang} [ i ] \.{=} Leader ]}%
 \@x{\@s{32.8} \.{\land} {\UNCHANGED} {\langle} currentTerm ,\, log ,\,
 msgsVars ,\, negMsgs ,\, leaderLog ,\, vote {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ClientRequest ( i ) \.{\defeq}}%
 \@x{\@s{32.8} \.{\LET} ind \.{\defeq} \{ b \.{\in} Index \.{:} leaderLog [
 currentTerm [ i ] ] [ b ] [ 1 ] \.{\neq} \.{-} 1 \}}%
\@x{\@s{53.19} nextIndex \.{\defeq} {\IF} ind \.{=} \{ \} \.{\THEN} 0}%
\@x{\@s{165.62} \.{\ELSE} Max ( ind ) \.{+} 1}%
\@x{\@s{32.8} \.{\IN} \.{\land} currentState [ i ] \.{=} Leader}%
\@x{\@s{53.19} \.{\land} nextIndex \.{\in} Index}%
 \@x{\@s{53.19} \.{\land} \E\, v \.{\in} Value \.{:} leaderLog \.{'} \.{=} [
 leaderLog {\EXCEPT} {\bang} [ currentTerm [ i ] ] [ nextIndex ] \.{=}
 {\langle} currentTerm [ i ] ,\, v ,\, {\FALSE} {\rangle} ]}%
 \@x{\@s{53.19} \.{\land} {\UNCHANGED} {\langle} serverVars ,\, log ,\, vote
 ,\, msgsVars ,\, negMsgs {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \E\, i \.{\in} Server \.{:} Restart ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} Timeout ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} ReceiveHighTerm ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} RequestVote ( i )}%
 \@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} HandleRequestVoteRequest
 ( i )}%
 \@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} BecomeLeaderCandidate ( i
 )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} BecomeLeader ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} CommitEntry ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} ClientRequest ( i )}%
 \@x{\@s{39.83} \.{\lor} \E\, i ,\, j \.{\in} Server \.{:} RequestCommit ( i
 )}%
 \@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:}
 HandleRequestCommitRequest ( i )}%
\@x{\@s{39.83} \.{\lor} \E\, i ,\, j \.{\in} Server \.{:} RequestSync ( i )}%
 \@x{\@s{39.83} \.{\lor} \E\, i \.{\in} Server \.{:} HandleRequestSyncRequest
 ( i )}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Tue} May 11
 19:47:37 \ensuremath{CST} 2021 by Dell
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon} May 10 22:09:59
